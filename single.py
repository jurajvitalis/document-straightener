...
# Read image
path = pathlib.Path('images/faktura.png')
...
# Create copy for the rotated image
img_rotated = img.copy()

# Detect lines_detected
lines_detected = detect_strong_lines(img)
print(f'Detected {lines_detected.size} strong lines =\n{lines_detected}')
...
output_filename = path.stem + '-rotated.png'
